...
public class Deconstructor {
	 ...
	 * @param k the minimum number of shares required to reconstruct the polynomial
	 */
	...
	public Share generate(){
		...
		BigInteger y = polynomial.evaluate(x).mod(this.prime); //each share is (x, f(x) mod p)
